...
**George Miller's magische Zahl 7±2** besagt, dass das menschliche Arbeitsgedächtnis nur 5-9 Informationseinheiten gleichzeitig verarbeiten kann. Eine durchschnittliche Datenschutzerklärung enthält jedoch:
- 23-47 verschiedene Verarbeitungszwecke
- 15-30 Datenkategorien
- 10-25 Empfängerkategorien
- 5-15 Rechtsgrundlagen

Insgesamt entstehen 50-100+ distinkte Informationselemente. Die kognitive Überlastung ist damit vorprogrammiert.

**Zum Transparenz-Paradox** zeigt die Forschung konsistent: Mehr Information führt paradoxerweise zu weniger Verständnis, erzeugt aber höheres (illusorisches) Kontrollgefühl. Studien mit randomisierten Gruppen deuten darauf hin, dass vereinfachte Darstellungen (ca. 5 Seiten) das Verständnis gegenüber Standard-DSGVO-Texten deutlich verbessern, während hypertransparente 40+-Seiten-Dokumente das schlechteste Verständnis erzeugen (← vgl. Kapitel 2.2 zu kognitiver Überlastung).
...
Menschen können nicht alles wahrnehmen. Eye-Tracking-Studien zeigen konsistent, dass nur ein kleiner Bruchteil der Datenschutztexte tatsächlich fixiert wird — McDonald & Cranor (2008) belegen, dass Nutzer im Schnitt nur wenige Sekunden mit Datenschutzerklärungen verbringen und nur einen Bruchteil des Textes lesen.

**2. Curse of Knowledge**:
Juristen und Techniker überschätzen systematisch, was Laien verstehen. Die Forschung zeigt eine erhebliche Lücke zwischen dem, was Sender für verständlich halten, und dem tatsächlichen Verständnis bei Nutzern — ein Gap, der systematisch unterschätzt wird.

**3. Information Avoidance**:
Aktives Vermeiden von Information als Schutzmechanismus ist gut belegt. Studien zeigen, dass ein erheblicher Anteil der Nutzer angibt, Datenschutzinformationen bewusst zu ignorieren — mit Begründungen wie "Es ändert eh nichts" oder "Zu deprimierend".
...
```
Nutzung in der Praxis: Studien zeigen, dass die oberste Ebene von der großen Mehrheit genutzt wird, während vertiefte Kategorien nur von einem kleinen Anteil der Nutzer angeklickt werden — und die vollständige Information kaum jemand erreicht.
...
- Kontextuelle Relevanz erhöht Aufmerksamkeit messbar

**3. Visual Transparency**:
Grafische statt textuelle Darstellung verbessert nachweislich Verständnis und Engagement. Studien zeigen, dass Datenfluss-Diagramme und Icon-basierte Kategorien das Verständnis und die Merkfähigkeit gegenüber reinen Texten deutlich steigern.
...
**Forschung zu Mental Models of Data Use** zeigt, dass Menschen stark vereinfachte Vorstellungen davon haben, was mit ihren Daten passiert. Studien, in denen Teilnehmer ihre Vorstellungen bildlich darstellen sollten, identifizierten folgende häufige mentale Modelle:
...
**Zur Zweck-Kompatibilität** zeigen Studien eine erhebliche Lücke zwischen juristischer und laienpsychologischer Bewertung. Wenn Teilnehmer verschiedene Zweck-Paare bewerten, ergibt sich folgendes Bild:
...
**Umfrage vs. Verhalten** zeigt eine deutliche Diskrepanz: Obwohl eine große Mehrheit der Befragten zustimmt, dass "Unternehmen zu viele Daten sammeln", und behauptet, selbst "nur nötige Daten" anzugeben, füllen in der Praxis die meisten Nutzer auch optionale Felder aus und geben freiwillig mehr Informationen als gefordert (Weber et al., 2024).

**Psychologische Treiber der Daten-Maximierung**

**1. Completeness Bias**:
Menschen haben einen inhärenten Drang, Dinge zu vervollständigen. Profil-Vollständigkeitsanzeigen, "Nur noch X Felder"-Hinweise und Gamification durch Fortschrittsbalken erhöhen die Bereitschaft zur Dateneingabe messbar.

**2. Reciprocity Norm**:
Kostenlosen Service mit Daten "bezahlen": Viele Nutzer empfinden Datenpreisgabe als faire Gegenleistung für einen kostenlosen Dienst. Studien zeigen, dass ein erheblicher Anteil dieser Logik folgt und Schuldgefühle bei "Datengeiz" empfindet.

**3. **[FOMO]** (Fear of Missing Out)**:
Die Angst, Features zu verpassen, treibt Datenpreisgabe. Sozialer Druck in Netzwerken verstärkt diese Dynamik messbar.
...
- "Was wenn wir die Daten später brauchen?" — diese Frage treibt Data Scientists um. Löschen fühlt sich wie Verlust an; Speichern ist billig, Löschen psychologisch teuer.
...
**Zum Prinzip "Minimal Viable Data"** zeigen kommunale Pilotprojekte (u. a. in niederländischen Städten): Stadt-Services lassen sich mit deutlich reduzierten Datensätzen betreiben. Die Funktionalität bleibt weitgehend erhalten, die Nutzerzufriedenheit unverändert, während Privacy-Incidents deutlich zurückgehen.
...
**Tägliche Einwilligungs-Exposition** ist erheblich: Studien schätzen, dass Nutzer täglich einer Vielzahl von Cookie-Bannern, App-Berechtigungen, Terms-of-Service und Marketing-Consents begegnen — Schätzungen bewegen sich im zweistelligen Bereich pro Tag.
...
**3. Forced Consent**:
"Zustimmen oder nicht nutzen": Eine große Mehrheit der Nutzer empfindet diese Situation nicht als echte Wahl, stimmt aber trotzdem zu. Die **[Reaktanztheorie]** ist messbar, bleibt aber wirkungslos.
...
**Zum Security-Privacy-Paradox** zeigen Umfragen konsistente Widersprüche: Eine Mehrheit erklärt "Sicherheit ist mir wichtiger als Privacy" und behauptet, starke Passwörter zu nutzen. Tatsächlich verwenden jedoch nur wenige Nutzer wirklich unique passwords oder Password Manager (Kumar et al., 2024).
...
**Nach Sicherheitsvorfällen** (→ siehe Kapitel 2.3) durchlaufen Nutzer typische Phasen: Shock ("Wie konnte das passieren?"), Anger ("Die haben nicht aufgepasst!"), Bargaining ("Wenn ich X ändere, bin ich sicher"), Depression ("Es ist hoffnungslos") und schließlich Acceptance ("Ist halt so im Internet").
