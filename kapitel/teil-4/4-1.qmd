...
**Empirische Befunde zum Einwilligungsverhalten** (Eye-Tracking und Verständnistests):
...
Die Diskrepanz ist bemerkenswert.
...
Befragungen zum Freiwilligkeitserleben zeigen konsistent: Nur ein kleiner Teil der Nutzer empfindet Einwilligungen als wirklich freiwillig. Die überwiegende Mehrheit fühlt sich eher oder vollständig gezwungen. Die gefühlte Freiwilligkeit ist marginal.
...
Obar & Oeldorf-Hirsch (2020) analysierten in ihrer Metaanalyse umfangreich Studien zum Einwilligungsverhalten. Die **zentralen Befunde** sind auffällig: Durchschnittliche Lesezeit beträgt 13,7 Sekunden, nur 1,4% lesen vollständig, 16,3% lesen teilweise, 31,2% nur die Überschrift und 51,1% akzeptieren direkt.
...
Eine Längsschnittstudie begleitete Teilnehmer über fünf Jahre. **Phase 1** (0-6 Monate) zeigte moderate Aufmerksamkeit mit 34% die zumindest teilweise lesen und einigen Anpassungen der Einstellungen. **Phase 2** (6-18 Monate) brachte rapiden Aufmerksamkeitsrückgang auf 12% die noch teilweise lesen, während automatisches Akzeptieren sich etablierte. **Phase 3** (18+ Monate) erreichte vollständige Habituation mit unter drei Prozent die überhaupt noch lesen und voll ausgeprägter "Consent Fatigue".
...
Das Behavioral Privacy Lab (2024) untersuchte **situative Einflüsse auf Einwilligungsqualität**. **Zeitdruck** reduziert informierte Entscheidungen deutlich: ohne Zeitdruck 29%, bei moderatem Zeitdruck 11% und bei hohem Zeitdruck nur zwei Prozent.
...
Menschen entwickeln eine **adaptive Toolbox für Datenschutz** mit verschiedenen Heuristiken: Recognition Heuristic (bekannte Services bevorzugen), Social Proof (tun was andere tun), Minimalist Approach (so wenig Daten wie möglich) und Avoidance (neue Services meiden). Verlässlich schützen sie nicht.
...
**Empirische Validierung** durch das Bounded Rationality Lab (2024) testete ein Experiment mit "idealen Bedingungen": keine Zeitbeschränkung, finanzielle Anreize für gute Entscheidungen, vereinfachte Sprache und nur eine Einwilligung. Das Ergebnis war ernüchternd: 43% trafen "rationale" Entscheidung (vs. 7% normal), 57% fielen trotzdem auf **[Dark Patterns]** rein und die durchschnittliche Zeit betrug zwölf Minuten (unrealistisch im Alltag).
