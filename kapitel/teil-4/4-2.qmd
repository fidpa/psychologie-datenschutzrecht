...
"Genau das ist das Problem", antwortet Miriam. "Diese Designer sind keine Bösewichte. Sie sind hoch qualifizierte Psychologen, die ihre Fähigkeiten einsetzen, um KPIs zu erfüllen. Das System belohnt Manipulation."
...
Fear Appeals nutzen Existenzängste mit Nachrichten wie "Ohne Zustimmung verlieren Sie Zugang" oder "Ihre Daten könnten gefährdet sein". Solche Angstappelle aktivieren schnelle, emotionale Verarbeitungsprozesse auf Kosten reflektierender Entscheidungen (vgl. Kahneman, 2011).
...
Das Gegenstück zu dieser verdeckten Reziprozitätsausbeutung bildet das transparente Daten-gegen-Ware-Modell, bei dem der Tausch offengelegt statt verschleiert wird. Ob eine Kopplung von Einwilligung und Leistung die Freiwilligkeit tatsächlich aufhebt, hängt nach Art. 7 Abs. 4 DSGVO vom Kontext ab (→ 4.1, Nicht-Koppelungsgebot). Die Transparenz des Austauschverhältnisses bildet das entscheidende Differenzierungskriterium zwischen legitimem Tausch und Dark Pattern.
...
Das Conversion-Rate-Paradox verdeutlicht den Zielkonflikt: Datenschutz-Labels können die Conversion-Rate kurzfristig steigern und Wettbewerbsvorteile schaffen, untergraben langfristig aber genau das Vertrauen, das die Datenökonomie als Währung benötigt (→ These 9). Wenn ein signifikanter Anteil der Labels substanzlos ist, entwertet dies auch die Signalwirkung für tatsächlich konforme Anbieter, ein klassisches "Market for Lemons"-Problem (Akerlof, 1970).
...
Die rechtliche Einordnung von Dark Patterns befindet sich im Fluss. Während einige Praktiken klar illegal sind, bewegen sich viele in Grauzonen. Die DSGVO und andere Regelwerke werden gegen manipulative Designs in Stellung gebracht.
...
Erfolgreiche Klagen umfassen den vzbv gegen Facebook (KG Berlin, Urt. v. 20.12.2019, Az. 23 U 66/19; BGH, Urt. v. 28.05.2020, Az. I ZR 7/20), die BEUC-Sammelbeschwerde gegen TikTok (Februar 2021) sowie laufende Verfahren von noyb gegen Cookie-Banner-Anbieter.
...
Die deutsche und europäische Rechtsprechung nähert sich der Grenzziehung zwischen zulässigem Nudging und unzulässiger Manipulation schrittweise an. Leitplanken bilden einerseits der Schutz der informationellen Selbstbestimmung und der Autonomie der Nutzer, andererseits der wettbewerbsrechtliche Maßstab des durchschnittlich informierten, aufmerksamen und verständigen Verbrauchers, der die Konsequenzen seiner Entscheidung erfassen können muss. Vorausgefüllte Kästchen wurden bereits im Planet49-Urteil des EuGH (C-673/17, 1. Oktober 2019) für unzulässig erklärt; die nationale Rechtsprechung vertieft diese Linie für typische Dark-Pattern-Konstellationen.
...
*Irish DPC gegen TikTok (Bescheid vom 15.09.2023)* — 345 Mio. EUR Bußgeld wegen u. a. Dark Patterns bei Kinderkonten:
...
Empirische Grundlage für diese Enforcement-Strategien liefern groß angelegte Crawl-Studien: Mathur et al. (2019) identifizierten in einer automatisierten Auswertung von 11.000 Shopping-Websites mehr als 1.800 Dark-Pattern-Instanzen; Nouwens et al. (2020) untersuchten 680 Cookie-Management-Plattformen und zeigten systematische Verstöße gegen die DSGVO-Anforderungen an freiwillige Einwilligung.
...
Langfristige Vorteile ethischen Designs umfassen nachhaltiges Vertrauen in Kundenbeziehungen, positive Markenwahrnehmung und Reputation, Compliance ohne Bußgeldrisiken, Innovation durch echte Problemlösung und Mitarbeiterstolz auf das Produkt. Belastbare branchenübergreifende [ROI]-Zahlen speziell für „Dark-Pattern-Entzug" liegen bisher nicht vor; typischerweise geht ein kurzfristiger Rückgang der Konversionsrate mit einer mittelfristig steigenden Kundenbindung und verringerten Rechtsrisiken einher.
