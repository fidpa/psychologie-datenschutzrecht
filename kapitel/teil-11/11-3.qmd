...
Ethnografische Beobachtungen in VRChat-Communitys dokumentieren, dass Nutzer aktiv "private Räume" schaffen und verteidigen. Ein Großteil der beobachteten Konflikte entsteht durch wahrgenommene Verletzungen des persönlichen Raums.
...
**Kryptografische Räume** (durch Ende-zu-Ende-Verschlüsselung gesicherte VR-Bereiche) bieten maximale Privatheit. In diesen VR-Bereichen hat selbst die Plattform keinen Zugriff auf Interaktionen. Die technische Herausforderung liegt in der Balance zwischen Sicherheit und Performance.
