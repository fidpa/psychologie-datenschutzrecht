...
**Ambient Privacy Indicators** nutzen subtile visuelle oder akustische Hinweise, um Datensammlung anzuzeigen. Das "Privacy Bird" des Carnegie Mellon University zeigt durch Farbwechsel an, wenn Daten gesammelt werden. In der Praxis blieb die Akzeptanz gering: Nur 23% der Testnutzer behielten die Indikatoren nach sechs Monaten aktiviert (Cranor et al., 2022).
...
Eine generationsübergreifende Studie (Miller & Davis, 2023) zeigte deutliche Unterschiede:
