...
Diese Unterschiede sind nicht nur auf der Verhaltensebene sichtbar, sondern dürften sich auch in anderen kognitiv-emotionalen Verarbeitungsprozessen niederschlagen: Bewertungen menschlicher Urteile aktivieren tendenziell stärker jene Ressourcen, die mit emotionaler Einbettung und Theory of Mind verbunden sind, während algorithmische Urteile eher distanziert-analytisch bewertet werden. Diese Asymmetrie manifestiert sich in messbarem Verhalten: Menschen sind bereit, für menschliche Entscheidungen durchschnittlich 27 Prozent höhere Gebühren zu zahlen als für algorithmische, selbst bei identischer Qualität (Castelo, Bos & Lehmann, 2019).

Das Vertrauensproblem verschärft sich durch die *Black-Box-Natur* vieler KI-Systeme. Während wir bei menschlichen Entscheidern zumindest die Illusion haben, ihre Beweggründe nachvollziehen zu können, bleiben die Entscheidungspfade neuronaler Netze oft opak. Diese Intransparenz triggert evolutionär verankerte Vorsichtsmechanismen: Was wir nicht verstehen, dem misstrauen wir instinktiv.
...
Das Expertise-Framing nutzt die psychologische **[Reaktanztheorie]** konstruktiv. Die Positionierung von Algorithmen als "Assistenten" statt "Entscheider" reduziert Widerstand. Lisa Chen implementierte diesen Ansatz in ihrem Versicherungskonzern: "Wir sprechen nie davon, dass die KI entscheidet. Stattdessen 'analysiert' sie, 'identifiziert Muster' oder 'unterstützt'. Diese semantische Verschiebung erhöhte die Nutzungsrate von 34 auf 78 Prozent."

Lisa Chens Beobachtung legt eine doppelte Schicht frei. Auf der Oberfläche reduziert die semantische Verschiebung Widerstand; unter der Oberfläche adressiert sie ein psychologisches Problem mit datenschutzrechtlicher Tiefenwirkung. Die Formulierung "die KI entscheidet" verschleiert nicht etwa eine offene rechtliche Frage, sondern die ohnehin klare Lage unter Art. 4 Nr. 7 DSGVO: Verantwortlicher ist immer eine natürliche oder juristische Person, niemals ein Modell. Wer dem System diskursiv Agency zuschreibt, verschiebt die Verantwortlichkeit nicht juristisch, aber wahrnehmungsmäßig. Genau diese Wahrnehmungsverzerrung untergräbt informierte Compliance in Organisationen.

Floridi (2023) liefert dafür den konzeptionellen Apparat. Sein Begriff der "Agency without Intelligence" trennt drei Ebenen, die in der Alltagssprache regelmäßig kollabieren: das **Modell** als zustandslose Funktion ohne Bewusstsein oder Verstehen, das **System** als Software-Architektur mit funktionaler Agency (Tool-Aufrufe, Datenflüsse, Aktionen in der Welt) und den **Verantwortlichen**, der DSGVO-rechtlich immer eine Person oder Organisation bleibt. Lisas Sprach-Hygiene fängt diese Dreiteilung intuitiv ein: Die KI "analysiert", die Organisation entscheidet.

Diese Lesart erweitert den Befund. **Sprach-Hygiene ist nicht nur UX-Strategie, sondern Compliance-Hygiene.** Wer in Organisationen anthropomorphe Sprache zulässt, lässt die Wahrnehmung dafür verschwimmen, wer eigentlich verantwortlich handelt — lange bevor ein konkreter Datenschutzvorfall die juristische Lage testet (→ siehe Kapitel 10.3 zur architektonischen Konkretion dieser Unterscheidung bei Sprachmodellen).

**Weiterführende Kapitel:** → 2.3

## 10.1.3 Die Illusion der Objektivität {#10-1-3-die-illusion-der-objektivitaet}

Einer der problematischsten Mythen im Kontext algorithmischer Entscheidungen ist deren vermeintliche Objektivität. Dieser Glaube, den die Forschung als *Objectivity Illusion* oder *Mathwashing* bezeichnet, ignoriert tiefgreifende psychologische und technische Realitäten. Algorithmen sind keine neutralen Werkzeuge, sondern kristallisierte menschliche Entscheidungen – mit all ihren Verzerrungen, Wertungen und blinden Flecken.
...
Die Konsequenzen der Objektivitätsillusion sind erheblich. Sie führt zu dem, was These 13 als "Scheinprüfung" bezeichnet – oberflächliche Kontrollmechanismen, die der kognitiven Überlastung nicht standhalten. Prof. Krügers Forschung zeigt: "Wenn Menschen glauben, ein System sei objektiv, sinkt ihre Prüfintensität um durchschnittlich 64 Prozent. Sie werden zu passiven Abzeichnern algorithmischer Entscheidungen."

Die Dekonstruktion der Objektivitätsillusion erfordert **[Algorithm Literacy]** – ein Verständnis dafür, wie Algorithmen funktionieren, wo ihre Grenzen liegen und welche Wertentscheidungen in sie eingeflossen sind. Das Value Sensitive Design thematisiert explizit die Werte, die in algorithmische Systeme eingebettet sind. Friedman et al. (2013) entwickelten Methoden, um Stakeholder daran zu beteiligen, diese Werte zu identifizieren und zu priorisieren.
...
Erfolgreiche Strategien zur Verbesserung der Fairness-Wahrnehmung beginnen mit partizipativer Algorithmen-Entwicklung. Betroffene Gruppen in die Definition von Fairness-Kriterien einzubeziehen adressiert das psychologische Bedürfnis nach *Voice* und *Representation*. Fairness-Feedback-Loops ermöglichen es Betroffenen, wahrgenommene Unfairness zu melden und Anpassungen anzustoßen. Dies stärkt das Gefühl der Kontrolle (→ siehe Kapitel 5.1).
...
Die Akzeptanz algorithmischer Entscheidungen variiert stark zwischen Kulturen. Diese Unterschiede reflektieren tieferliegende kulturelle Werte, historische Erfahrungen und divergierende Konzeptionen von Mensch, Maschine und Gesellschaft. Das Verständnis dieser kulturellen Dimension ist essenziell für die globale Governance von KI-Systemen.
