...
Diese Konsistenz-Illusion ist nur eine von mehreren Fehlattributionen, die in der Praxis regelmäßig auftreten. In Runden mit datenverantwortlichen Fachleuten lassen sich Klassen typischer Verwechslungen unterscheiden: Das Sprachmodell "sende" oder "logge" Daten eigenständig, es "wisse" über die umgebende Anwendung Bescheid, es "erzeuge" oder "generiere" Artefakte selbständig, es "lerne" aus laufenden Konversationen, es "erinnere sich" an frühere Sitzungen. Allen Varianten gemeinsam ist die Verwechslung des zustandslosen Modells mit dem System, in das es eingebettet ist.

Shanahan (2024) macht die Unterscheidung explizit. Er trennt das eigentliche neuronale Netzwerk als zustandslose mathematische Funktion vom umgebenden System aus Architektur- und Agency-Komponenten. Wer die Software-Architektur (Tool-Calling, MCP, Memory-Features, Telemetrie, Datenpipelines) als Akteur missversteht, schreibt einer Funktion Eigenschaften zu, die sie strukturell nicht besitzt. Das Modell selbst entscheidet nichts, sendet nichts, erinnert sich an nichts; alle handlungsrelevanten Operationen liegen in der umgebenden Architektur. Mitchell und Krakauer (2023) bringen diese Einsicht auf den Punkt: Sprachmodelle ähneln eher komprimierten Wissens-Repositorien wie Bibliotheken oder Enzyklopädien als intelligenten Akteuren. Eine Bibliothek erinnert sich nicht; gegriffen wird darin von außen.

Datenschutzrechtlich liegt darin der Schlüssel zur Verantwortlichkeitsfrage (← vgl. Kapitel 10.1). Wer die Architektur erkennt, erkennt auch, dass jede Aktion einer Person oder Organisation zuzurechnen ist, die das System aufruft, konfiguriert oder bereitstellt. Die populäre Formulierung "die KI hat das gemacht" ist nicht falsch in einem juristisch entscheidenden Sinn. Sie ist falsch in einem psychologisch entscheidenden Sinn, weil sie die handelnden Instanzen unsichtbar macht.
...
Klare ethische Standards für LLM-Persönlichkeiten sind essenziell. Die Simulation von Emotionen oder persönlichen Backstories sollte streng reguliert werden. Dies gilt besonders in sensiblen Kontexten.
...
**Realitätserosion**: Wiederholte Exposition gegenüber plausiblen Falschinformationen kann die Grenze zwischen Fakt und Fiktion verwischen. Besonders vulnerabel sind Menschen mit geringer Medienkompetenz oder in informationally impoverished Umgebungen.
...
Die Interaktion mit LLMs kann das Selbstkonzept beeinflussen. Menschen beginnen, sich selbst durch die Linse der KI zu sehen. Dieses Phänomen erinnert an das **Algorithmic Self** (→ siehe Kapitel 5.4), ist aber noch intimer. Erste Beobachtungen deuten darauf hin, dass intensive LLM-Nutzer ihre Selbstbeschreibung über die Zeit in Richtung der Sprache und Konzepte anpassen, die die KI verwendet – ein Effekt, der an Turkles (2017) Befunde zur Wechselwirkung zwischen Mensch und Technologie anknüpft.
...
Mehrere Strategien helfen beim Umgang mit diesen psychologischen Effekten. Analog zu Screen-Time-Limits brauchen wir Richtlinien für gesunde LLM-Interaktion. Pausen, Reflexionszeit und bewusste menschliche Interaktion sind essenziell.
...
Mitarbeiter brauchen nicht nur technische Schulungen. Sie benötigen auch psychologische Vorbereitung auf die Arbeit mit menschenähnlichen KI-Systemen. Besonders kritisch ist der Umgang mit der Versuchung, menschliche Interaktion durch KI-Systeme zu ersetzen. Die Kosteneinsparungen mögen verlockend sein. Die langfristigen psychologischen und sozialen Kosten könnten jedoch erheblich sein.
...
Die Versuchung, Bildung an KI zu delegieren, muss gegen die Notwendigkeit menschlicher Entwicklung abgewogen werden. Kritisches Denken wird wichtiger denn je. In einer Welt, wo KI jeden Standpunkt eloquent vertreten kann, ist dies essenziell.
...
Regulierung muss über technische Standards hinausgehen. Sie sollte psychologisches Wohlbefinden adressieren. Möglicherweise brauchen wir ein "Recht auf menschliche Interaktion". Limits für KI-Substitution in kritischen Bereichen könnten nötig sein. Die Förderung von Forschung zu psychologischen Effekten von KI-Systemen ist essenziell.
...
Diese Frage gewinnt durch ein wachsendes Phänomen an Dringlichkeit. Unter dem Begriff **AI Slop** beschreibt die öffentliche Debatte die Überflutung digitaler Räume mit minderwertigen, maschinell generierten Inhalten. Suchmaschinen, soziale Netzwerke und Kommunikationsplattformen füllen sich zunehmend mit Texten, Bildern und Empfehlungen, die kein Mensch verfasst hat. Die Parallele zur **Privacy Fatigue** (→ siehe Kapitel 7.2) ist erkennbar, doch der Mechanismus wirkt auf einer anderen Ebene: Nicht die Menge an Entscheidungen erschöpft die Nutzer, sondern die schiere Masse an Inhalten, deren Herkunft und Qualität sie nicht mehr beurteilen können. Sweller (1988) beschrieb mit der **Cognitive Load Theory** die Grenzen menschlicher Informationsverarbeitung. AI Slop verschärft diese Überlastung, weil gewohnte Qualitätssignale versagen: Sprachliche Flüssigkeit, formale Korrektheit und scheinbare Expertise kennzeichnen KI-generierte Texte ebenso wie menschliche Beiträge. Das Ergebnis ist eine Signal-Erosion, die traditionelle Vertrauensheuristiken entwertet.

Die psychologische Gegenreaktion folgt einem Muster, das die Selbstbestimmungstheorie erklärt (Deci & Ryan, 2000). Das Bedürfnis nach Verbundenheit treibt Menschen zurück zu authentischer menschlicher Interaktion. Live-Formate, persönliche Gespräche und Veranstaltungen gewinnen an Attraktivität, weil sie ein Versprechen einlösen, das digitale Kanäle zunehmend schuldig bleiben: die Gewissheit, einem Menschen gegenüberzustehen.

Felix Hartmann beobachtet diese Dynamik in seinem beruflichen Umfeld. Fachbeiträge in Online-Netzwerken, die früher als Expertise-Signale funktionierten, verlieren an Glaubwürdigkeit. „Wenn jeder mit einem Prompt einen überzeugenden Fachartikel generieren kann, wird die Fähigkeit zur Veröffentlichung wertlos als Kompetenznachweis", reflektiert er. Was bleibt, ist der direkte Austausch, die nachprüfbare Handlung, das persönliche Gespräch.

Der Ruf nach einem „Recht auf menschliche Interaktion" gewinnt damit psychologische Substanz. Diese Forderung ist nicht nur normativ, sondern empirisch begründet: Wo maschinell erzeugte Inhalte authentische Kommunikation verdrängen, brauchen Menschen geschützte Räume für echte Begegnung. Die Konsequenzen für die Datenschutzkommunikation sind unmittelbar (→ 14.1): Wenn KI-generierte Inhalte das Vertrauen in schriftliche Botschaften untergraben, müssen Datenschutzverantwortliche ihre Kommunikationsstrategien grundlegend überdenken.

Die Anthropomorphisierung erzeugt damit eine Verzerrung, die sich in zwei Richtungen ausprägt, beide datenschutzpsychologisch problematisch, aber mit unterschiedlich starker Belegbasis. Auf der einen Seite ist das Über-Trust-Phänomen empirisch gut belegt: Menschen teilen mit anthropomorphisierten Systemen mehr sensible Daten (Lucas et al., 2014), erhöhen die unkritische Übernahme ihrer Aussagen (Peter, Riemer & West, 2025, die zugleich auch Vorteile der Anthropomorphisierung dokumentieren) und entwickeln parasoziale Bindungen, die das Risikoempfinden absenken (Inie et al., 2024). Auf der anderen Seite lässt sich eine komplementäre Blindheit als Hypothese formulieren: Wer das System als Akteur erlebt, fokussiert auf simulierte Persönlichkeit und übersieht die architektonischen Datenflüsse, in denen die echten Verarbeitungsprozesse stattfinden. Carlini et al. (2023) belegen, dass Trainingsdaten-Reproduktion technisch existiert; ob sie zusammen mit Kontextkollaps und Telemetrie der App-Schicht aufgrund anthropomorpher Wahrnehmung systematisch unterschätzt werden, bleibt eine plausible, aber nicht direkt belegte Folgerung.

Diese Janus-Diagnose hat damit unterschiedliche Belegbasen. Während die Über-Trust-Seite empirisch konvergiert, verbindet die Unter-Trust-Seite Privacy-Paradox-Befunde (Norberg et al., 2007; Acquisti et al., 2015) mit der Anthropomorphisierungs-Literatur — eine plausible Hypothese, die in der Forschung bisher nicht als einheitliches Konstrukt formuliert wurde. Die Diagnose verbindet These 13 (KI-Transparenz) und These 3 (Dark Patterns): Wenn anthropomorphe Sprache strukturell Vertrauen aufbaut und gleichzeitig die Wahrnehmung der echten Risiken trübt, reichen Warnungen vor Anthropomorphisierung allein nicht aus. Es braucht **Sprach-Hygiene als Compliance-Hygiene** (← vgl. Kapitel 10.1), architektonische Klarheit und Schulungen, die die Dreiteilung Modell – System – Verantwortlicher explizit vermitteln (→ Kapitel 14.2).
