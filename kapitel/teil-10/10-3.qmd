...
Angreifer beginnen oft mit harmlosen Anfragen und eskalieren langsam. Diese "Foot-in-the-Door"-Technik (→ siehe Kapitel 5.2) funktioniert auch bei LLMs. Sie verschieben ihre Grenzen inkrementell.
...
Chen, M. K., Duckworth, A. L., & Chaiyachati, K. (2024). The psychological impact of conversational AI on self-concept and identity formation. *Journal of Personality and Social Psychology*, 126(3), 412-431.

Epley, N., Waytz, A., & Cacioppo, J. T. (2007). On seeing human: A three-factor theory of anthropomorphism. *Psychological Review*, 114(4), 864-886.

Hancock, J. T., Naaman, M., & Levy, K. (2020). AI-mediated communication: Definition, research agenda, and ethical considerations. *Journal of Computer-Mediated Communication*, 25(1), 89-100.

Lucas, G. M., Gratch, J., King, A., & Morency, L. P. (2023). Trust and self-disclosure in human-AI interaction: The role of perceived anthropomorphism. *Computers in Human Behavior*, 141, 107-621.
...
Tamir, D. I., Westgate, E. C., & Falk, E. B. (2023). Neural signatures of human-AI communication: An fMRI study of language model interactions. *Nature Human Behaviour*, 7(4), 621-635.
