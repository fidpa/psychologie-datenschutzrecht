...
**Die Ökonomie der Geister** ist zynisch. Plattformen profitieren von digitalen Leichen. Tote User zählen zu Monthly Active Users. Interaktionen mit Gedenkseiten generieren Engagement. Emotionale Bindung erhöht Plattform-Loyalty. Prognosen zur digitalen Mortalität zeigen, dass die Zahl verstorbener Nutzer auf Plattformen wie Facebook über die Jahrzehnte erheblich wächst — in bestimmten Szenarien übersteigt sie bis 2070 die Zahl der lebenden Nutzer (Öhman & Watson, 2019).
...
**Islam** hat klare Konzepte. Das Konzept der **[Amanat]** sieht Daten als anvertrautes Gut. Digitale Spuren sind Teil der Taten-Bilanz. Löschung problematischer Inhalte gilt als Barmherzigkeit. Viele muslimische Familien wünschen eine „Reinigung" digitaler Profile der Verstorbenen.
...
**Säkulare Spiritualität** entsteht neu. Digitale Unsterblichkeit wird als Transzendenz verstanden. Upload-Fantasien und KI-Resurrection werden diskutiert. Neue Mythen entstehen. Ein nicht unerheblicher Teil der Bevölkerung glaubt an eine Form digitalen Weiterlebens.
